...
/*
    1. Compile and run the file using any IDE that supports Java
    2. Options must be typed correctly, matching the case of the word as shown
    3. To end the program, log out of any account and type Exit
    4. Input for test cases is provided within the document
    5. Have fun, hope you enjoy the program!
 */
